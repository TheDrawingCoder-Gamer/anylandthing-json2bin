...
class Charset {
	...
	**/
	...
	public function isCJK(code) {
		...
		return (code >= 0x2E80 && code <= 0x2FFF)
			...
			|| // SMALL PLUS SIGN..SMALL EQUALS SIGN
			(code >= 0xFF01 && code <= 0xFF5A)
			|| // Fullwidth Latin letters and digits
			(code >= 0x20000 && code <= 0x3FFFD)
			|| // CJK Unified Ideographs Extension B-E, CJK Compatibility Ideographs Supplement, SIP (Plane 2) and TIP (Plane 3)
		#else
