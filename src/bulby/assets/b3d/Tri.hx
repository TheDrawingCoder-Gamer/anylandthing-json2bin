...
abstract Tri(TriRaw) {
	...
	public function copy():Tri {
		return new Tri(new VertRef(this.v1.position, this.v1.normal, this.v1.uv), new VertRef(this.v2.position, this.v2.normal, this.v2.uv),
...
abstract DirectTri(DirectTriRaw) {
	...
	public function toTriForMesh(mesh:Mesh) {
		return new Tri(new VertRef(mesh.positions.indexOfVector3(this.v1.position), mesh.normals.indexOfVector3(this.v1.normal),
			mesh.uvs.indexOfVector2(this.v1.uv)),
